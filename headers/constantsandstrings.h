...
const QString STR_HelpToProjectTitle = QObject::tr("Помощь проекту");
const QString STR_HelpToProjectText = QObject::tr("Проект был создан в рамках задачи \"Ну мне там 1 график построить\", "
	"и спустя 2 года перерос в инструментарий средней паршивости для быстрого просмотра и анализа данных, создаваемых в "
	"расчётных программах CRYSTAL и Quantum Espresso. Алгоритмы, созданные много лет назад, не покрывают все возможные случаи, "
	"не безопасны и плохо написаны. Если у вас есть желание доработать программу, исправить ошибки, или переписать ее функции - "
	"то исходный код проекта лежит на GitHub-репозитории.<br><br>"
	"Заранее благодарю тех смельчаков, что решились на это.<br><br>"
	"<a href='https://github.com/small23/QGraphViewer'>Исходный код</a>");
