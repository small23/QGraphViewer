...
void AtomConversion::convertAndSearchAtoms()
{
    ...
    ui->tab3ConvertedAtomsTable->setHorizontalHeaderLabels(QStringList() << "№ исх. ат." << "N ат. в элм. яч." << "n1" << "n2" << "n3");
    if (ui->tab3ConvertedAtomsTable->rowCount()>0)
    {
        ...
        if (fileName!="")
        {
         ...
         QMessageBox::warning(this, tr("Ошибка обработки"), tr("Атомы не найдены! Проверьте правильность ввода информации."));
}